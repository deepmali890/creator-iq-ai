...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_industryInsightsId_fkey" FOREIGN KEY ("industryInsightsId") REFERENCES "IndustryInsights"("id") ON DELETE SET NULL ON UPDATE CASCADE;
